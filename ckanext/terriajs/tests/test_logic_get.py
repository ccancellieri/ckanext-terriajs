...
#
#
#     def _test_type_of_not_group_is_disabled_return_false(self):
...
#
#
#     def _test_type_of_not_group_is_enabled_return_true(self):
#         _package = factories.Dataset(owner_org=self.owner_org['id'])
#         _params = {
#             'package_id': _package['id'],
#             'url': 'http://data',
...
#
#     def _test_is_config_disabled(self):
#         _package = factories.Dataset(owner_org=self.owner_org['id'])
#         _params = {
#             'package_id': _package['id'],
#             'url': 'http://data',
...
#
#
#     def _test_is_config_enabled(self):
#         _package = factories.Dataset(owner_org=self.owner_org['id'])
#         _params = {
#             'package_id': _package['id'],
#             'url': 'http://data',
